...
execute as @s[scores={bee_trigger=1..},tag=queen_bee_rider] on vehicle if entity @s[scores={bee_speed=0}] on passengers run title @s actionbar [{"text":"<","color":"gold"},{"text":"<","color":"#703e0f"},{"text":"< ","color":"gold"},{"text":"0","font":"honeycomb","color":"white"},{"text":" >","color":"gold"},{"text":">","color":"#703e0f"},{"text":">","color":"gold"}]
execute as @s[scores={bee_trigger=1..},tag=queen_bee_rider] on vehicle if entity @s[scores={bee_speed=1}] on passengers run title @s actionbar [{"text":"<","color":"gold"},{"text":"<","color":"#703e0f"},{"text":"< ","color":"gold"},{"text":"00","font":"honeycomb","color":"white"},{"text":" >","color":"gold"},{"text":">","color":"#703e0f"},{"text":">","color":"gold"}]
execute as @s[scores={bee_trigger=1..},tag=queen_bee_rider] on vehicle if entity @s[scores={bee_speed=2}] on passengers run title @s actionbar [{"text":"<","color":"gold"},{"text":"<","color":"#703e0f"},{"text":"< ","color":"gold"},{"text":"000","font":"honeycomb","color":"white"},{"text":" >","color":"gold"},{"text":">","color":"#703e0f"},{"text":">","color":"gold"}]
